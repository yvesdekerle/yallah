...
const PHRASE_TRANSLATIONS: [RegExp, string][] = [
  ...
  [/pierres tombales/g, 'tombstones'],
  [/diner gastronomique/g, 'fine dining'],
  [/courses hippiques/g, 'horse racing'],
  [/route du the/g, 'tea trail'],
  [/feu de bois/g, 'wood fire'],
  [/place d['\s]armes/g, 'town square'],
  [/place des armes/g, 'town square'],
  [/tea ceremony/g, 'tea ceremony'],
  [/tour martello/g, 'martello tower'],
  [/tour de prison/g, 'prison tower'],
  [/route du sucre/g, 'sugar trail'],
]
...
const WORD_TRANSLATIONS: Record<string, string> = {
  ...
  // Specifics
  gibier: 'game meat',
  hippique: 'horse racing',
  hippiques: 'horse racing',
  champ: 'field',
  // martello is handled via the multi-word phrase "tour martello"
  // → "martello tower" so it doesn't double up here.
  bulle: 'bubble',
  vanille: 'vanilla',
  marin: 'marine',
  coloniales: 'colonial',
...
const STOPWORDS = new Set([
  ...
  'saison', 'soit', 'parfois', 'directement', 'totale', 'organise',
  'visitable', 'independant', 'collectif', 'rapide',
  ...
  // Days of the week + months — useless for photo search:
